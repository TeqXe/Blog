$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '状态', name: 'state', index: 'state', width: 50,formatter: function(value, options, row){
                    return value === 0 ?
                        '<span class="label label-warning">待审核</span>' :value === 1?'<span class="label label-success">审核通过</span>':
